...
const Header = () => {
  ...
  const handleSubmit =(e)=> {
    ...
    navigate(`/results?search_guery=${text}`);

    };
  return (
    <div className="flex justify-between items-center p-4">
        <Link to="/" className="flex items-center gap-2">
        <img className="w-[75px]" src="/youtube1.png" alt="youtube logo" />
        <h1 className="text-2xl font-mono max-sm:hidden">Youtube</h1>
        </Link>
        <form onSubmit={handleSubmit} className="flex border border-gray-400 rounded-3xl overflow-hidden">
            ...
            <button className="px-4 text-2xl bg-zinc-800 hover:bg-zinc-600 transitio duration-300">
                <IoIosSearch/>
